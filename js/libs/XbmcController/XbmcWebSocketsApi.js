...
Xbmc.WebSocketsApi = function(options) {
	...
	var _settings = _extend({
		host: window.location.host.split(':')[0] || 'localhost'
		,port: '9090'
		,autoRetry: true
...
*/
	...
	function _onWsMessage(msg) {
		...
		//this line is to avoid errors like "Could not decode a text frame as UTF-8"
		var obj = JSON.parse( decodeURIComponent( encodeURIComponent( json ) ) );
